...
public class CelebrityPanel extends JPanel implements ActionListener {
  ...
  private void setupListeners() {
    ...
    resetButton.addActionListener(this); // part 4
  ...
  public void actionPerformed(ActionEvent ae) {
    ...
    if (source instanceof Timer) {
      ...
      if (buttonText.equals("Submit guess")) {
        updateScreen();
      } else if (buttonText.equals("Start again")) { // part 4
        staticTimerLabel.setText("Time remaining: ");
        dynamicTimerLabel.setText("30");
        guessField.setText(""); // clear last guess
        clueArea.setText(""); // clear clue area
        clueArea.setBackground(Color.WHITE);
        guessButton.setEnabled(true);
        guessField.setEnabled(true);
        controller.reset(); // new method
      }
    }
  }
}